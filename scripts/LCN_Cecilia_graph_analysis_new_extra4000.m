...
% 
% nr_permutations    = 4000;
% nr_groups = 8; % subdivide in the number of permutations in different groups so that after each group data are saved
...
% 
outputname = 'workspace_correlations_90_regions_corTGMV_new_extra4000';
