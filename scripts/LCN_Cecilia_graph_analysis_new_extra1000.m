...
% %
% outputname = 'workspace_correlations_90_regions_raw_new_extra4000';
% 
% nr_permutations    = 1000;
% nr_groups = 4; % subdivide in the number of permutations in different groups so that after each group data are saved
% % REMARK: the number of permutation should equal an integer number times the number of groups 
% 
...
% %
% 
% nr_permutations_per_group = nr_permutations/nr_groups;
% if mod(nr_permutations,nr_groups) ~= 0
%    return;
% end
% 
...
% eval(['save ' outputname ' -v7.3']);
% 
% %
% for groupvalue = 1:nr_groups
%     for rand_i = nr_permutations_per_group(groupvalue-1)+1:nr_permutations_per_group*groupvalue
...
% 
outputname = 'workspace_correlations_90_regions_corTGMV_new_extra1000';

nr_permutations    = 1000;
nr_groups = 2; % subdivide in the number of permutations in different groups so that after each group data are saved
% REMARK: the number of permutation should equal an integer number times the number of groups 
nr_randomizations1 = 10;  % number of randomizations used to normalize the 
%                           graph measures by dividing by the average value 
%                           obtained in this number of equivalent random 
